(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@angular/common'), require('@angular/forms'), require('@angular/platform-browser'), require('js-beautify'), require('clipboard'), require('lodash'), require('rxjs/add/operator/toPromise'), require('primeng/primeng')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common/http', '@angular/common', '@angular/forms', '@angular/platform-browser', 'js-beautify', 'clipboard', 'lodash', 'rxjs/add/operator/toPromise', 'primeng/primeng'], factory) :
	(factory((global.ng = global.ng || {}, global.ng['seed-images'] = {}),global.ng.core,global.ng.httpClient,global.ng.common,global.ng.forms,global.ng['platform-browser'],global['js-beautify'],global.clipboard,global.lodash,null,global.primeng));
}(this, (function (exports,core,http,common,forms,platformBrowser,beautify,Clipboard,lodash,toPromise,primeng) { 'use strict';

beautify = beautify && beautify.hasOwnProperty('default') ? beautify['default'] : beautify;
...
var SeedImagesComponent = /** @class */ (function () {
    function SeedImagesComponent(http$$1, domSanitizer) {
        this.http = http$$1;
        this.domSanitizer = domSanitizer;
        this.imageImport = new core.EventEmitter();
        this.jobs = [];
        this.jobVersions = [];
        this.images = [];
    ...
    SeedImagesComponent.propDecorators = {
        ...
        "imageImport": [{ type: core.Output },],
    };
    return SeedImagesComponent;
}());

var SeedImagesModule = /** @class */ (function () {
    function SeedImagesModule() {
    }
    SeedImagesModule.decorators = [
    ...
    /** @nocollapse */
    SeedImagesModule.ctorParameters = function () { return []; };
    return SeedImagesModule;
}());

exports.SeedImagesModule = SeedImagesModule;
exports.SeedImagesComponent = SeedImagesComponent;
