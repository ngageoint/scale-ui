...
@Component({
    selector: 'dev-testing',
    templateUrl: './component.html',
    styleUrls: ['./component.scss'],
    providers: [NewChartService]
})
export class TestingComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private jobsService: NewChartService,
                ...
                xAxes: [{
                    ...
                    ticks: {
                        callback: (value, index, values) => {
                            ...
                            return moment.utc(values[index]['value']).format('DD MMM HHmm');
                        }
                    }
                }],
                yAxes: [{
    ...
    ngAfterViewInit() {
        if (this.chart.chart) {
            this.chart.chart.canvas.parentNode.style.height = '400px';
        }
    }
